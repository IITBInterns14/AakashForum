...
<!-- MODAL -->
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div >
                <center>
                <font face="Times New Roman" size="6"><b>Department of Computer Science </b></font>
                <br>
        
                <font face="Times New Roman" size="4">Prof.Anuradha	</font>
                <br>
            	 
                </center>   	
		<br>
                <br>
	        <font face="Bradley Hand ITC" size="6"><b> Life Science </b></font>
                <br>
                <br>
            </div>
                <% 
                 ...
                 Statement statement = connection.createStatement();
                        ResultSet resultset = statement.executeQuery("select * from qa where SessionId=1 ") ; 
...
<script type="text/javascript">
	 ...
	 function saveAns()
	 {
		 ...
		 response.sendRedirect("lec11.jsp#user"+tobeanswered);
	 ...
	 function delQues(clicked_id)
	 {
		...
		document.getElementById("futureid").value="user"+v;
		 ...
		 response.sendRedirect("lec11.jsp#"+futid);
