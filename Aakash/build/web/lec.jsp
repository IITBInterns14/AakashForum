...
<form action="Login" method="post">
        <ul class="nav nav-pills pull-right">
          ...
          <li><a href="get3.jsp">Logout</a></li>
...
<div >
     ...
     <br>
                 ...
                 <font face="Times New Roman" size="4">Prof.D.B.Phatak	</font>
     <br>
            	 
  	</center>   	
		<br>
                <br>
	            <font face="Bradley Hand ITC" size="6"><b> Analysis Of Algorithms </b></font>
 ...
 <% 
 Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/aakash", "root", "root");
 Statement statement = connection.createStatement();
	ResultSet resultset = 
    statement.executeQuery("select * from qa") ; 
