...
<div class="page1" >          
                <center>
                    ...
                    <font face="myFontThin" size="6" class="title">Department of  </font><font face="myFontThick" size="8"><b>Aerospace Engineering</b></font>
                <br>
                   <font face="myFontThick" size="5">Prof. mlmlmlkm</font>
                
                </center>
                <br> <br>  <font face="myFontThick" size="6"><b> mk </b></font>
<br><br><br>
            ...
            Statement statement = connection.createStatement();
                   ResultSet resultset = statement.executeQuery("select * from qa25;") ; 
 ...
 <script type="text/javascript">
	 ...
	 function saveAns()
	 {
		 ...
		 Statement stmt = connection.createStatement();
			String query="update qa25 set ans ='"+answer+"' where id='"+tobeanswered+"';";
	 ...
	 function delQues(clicked_id)
	 {
		...
		document.getElementById("futureid").value="user"+v;
		 ...
		 Statement stmt1 = connection.createStatement();
			String query1="delete from qa25 where id='"+tobedel+"';";
