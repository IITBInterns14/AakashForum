...
<div >
     ...
     <br>
		...
		<br>
                <br>
	            <font face="Bradley Hand ITC" size="6"><b> BCDE </b></font>
 ...
 Statement statement = connection.createStatement();
	ResultSet resultset = statement.executeQuery("select * from qa22 ") ; 
...
<script type="text/javascript">
	 ...
	 function saveAns()
	 {
		 ...
		 Statement stmt = connection.createStatement();
			String query="update qa22 set ans ='"+answer+"' where id='"+tobeanswered+"'";
	 ...
	 function delQues(clicked_id)
	 {
		...
		document.getElementById("futureid").value="user"+v;
		 ...
		 Statement stmt1 = connection.createStatement();
			String query1="delete from qa22 where id='"+tobedel+"'";
