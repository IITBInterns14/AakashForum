...
<div class="page1" >          
                ...
                <br>
                   <font face="myFontThick" size="5">Prof. Swati</font>
                
                </center>
                <br> <br>  <font face="myFontThick" size="6"><b> Android </b></font>
<br><br><br>
            ...
            Statement statement = connection.createStatement();
                   ResultSet resultset = statement.executeQuery("select * from qa2;") ; 
 ...
 <script type="text/javascript">
	 ...
	 function saveAns()
	 {
		 ...
		 Statement stmt = connection.createStatement();
			String query="update qa2 set ans ='"+answer+"' where id='"+tobeanswered+"';";
	 ...
	 function delQues(clicked_id)
	 {
		...
		document.getElementById("futureid").value="user"+v;
		 ...
		 Statement stmt1 = connection.createStatement();
			String query1="delete from qa2 where id='"+tobedel+"';";
